...
While in the search loop, hit =M-c= to toggle case sensitivity: you
...
- =C-s M-s r= to toggle search by regular expressions
- =C-s M-w= to search for word at point

Enjoy!

And check the [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Incremental-Search.html][Emacs manual]] for more.
