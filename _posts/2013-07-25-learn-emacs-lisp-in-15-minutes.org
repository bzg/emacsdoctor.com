...
#+excerpt: I was surprised not to find an introduction to Emacs Lisp on http://learnxinyminutes.com so I created one.  This page is now on http://learnxinyminutes.com/docs/elisp/ too.

I was surprised not to find an introduction to Emacs Lisp on
[[http://learnxinyminutes.com]] so I created one.  This page is now on
http://learnxinyminutes.com/docs/elisp/ too.
