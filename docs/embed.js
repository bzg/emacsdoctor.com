...
(function() {
    ...
    var scriptsToLoad = ["//s3.amazonaws.com/s3.www.universalsubtitles.org/e709914d/js/unisubs-offsite-compiled.js"];

    var siteConfig = {
        siteURL: 'http://amara.org',
        staticURL: '//s3.amazonaws.com/s3.www.universalsubtitles.org/e709914d/'
    };
    ...
    if (!window.MiroCSSLoading) {
        ...
        css.type = 'text/css';
        css.rel = 'stylesheet';
        css.href = '//s3.amazonaws.com/s3.www.universalsubtitles.org/e709914d/css/widget.css';
        css.media = 'screen';
